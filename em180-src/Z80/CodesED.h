...
/* jdw: 64180 MLT instruction */
case MLT_BC:
	R->BC.W = (unsigned int) R -> BC.B.l * 
			(unsigned int) R -> BC.B.h ;
    break ;

case MLT_DE:
	R->DE.W = (unsigned int) R -> DE.B.l * 
			(unsigned int) R -> DE.B.h ;
    break ;

case MLT_HL:
	R->HL.W = (unsigned int) R -> HL.B.l * 
			(unsigned int) R -> HL.B.h ;
    break ;

case MLT_SP:
	R->SP.W = (unsigned int) R -> SP.B.l * 
			(unsigned int) R -> SP.B.h ;
    break ;

/* jdw: 64180 IN0 instruction */
case IN0_B:  
    M_IN0(R->BC.B.h);break;

case IN0_C:  
    M_IN0(R->BC.B.l);break;

case IN0_D:  
    M_IN0(R->DE.B.h);break;

case IN0_E:  
    M_IN0(R->DE.B.l);break;

case IN0_H:  
    M_IN0(R->HL.B.h);break;

case IN0_L:  
    M_IN0(R->HL.B.l);break;

case IN0_None:  
    M_IN0(J.B.l);break;

case IN0_A:  
    M_IN0(R->AF.B.h);break;


/* jdw: 64180 OUT0 instruction */
case OUT0_B:
	OutZ80(RdZ80(R->PC.W++),R->BC.B.h);break;

case OUT0_C:
	OutZ80(RdZ80(R->PC.W++),R->BC.B.l);break;

case OUT0_D:
	OutZ80(RdZ80(R->PC.W++),R->DE.B.h);break;

case OUT0_E:
	OutZ80(RdZ80(R->PC.W++),R->DE.B.l);break;

case OUT0_H:
	OutZ80(RdZ80(R->PC.W++),R->HL.B.h);break;

case OUT0_L:
	OutZ80(RdZ80(R->PC.W++),R->HL.B.l);break;

case OUT0_A:
	OutZ80(RdZ80(R->PC.W++),R->AF.B.h);break;

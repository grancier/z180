...
/* jdw: support for 64180 IN0 instruction: */
#define M_IN0(Rg)  Rg=InZ80(RdZ80(R->PC.W++)); \
...
enum CodesED
{
  IN0_B,OUT0_B,DB_02,DB_03,DB_04,DB_05,DB_06,DB_07,
  IN0_C,OUT0_C,DB_0A,DB_0B,DB_0C,DB_0D,DB_0E,DB_0F,
  IN0_D,OUT0_D,DB_12,DB_13,DB_14,DB_15,DB_16,DB_17,
  IN0_E,OUT0_E,DB_1A,DB_1B,DB_1C,DB_1D,DB_1E,DB_1F,
  IN0_H,OUT0_H,DB_22,DB_23,DB_24,DB_25,DB_26,DB_27,
  IN0_L,OUT0_L,DB_2A,DB_2B,DB_2C,DB_2D,DB_2E,DB_2F,
  IN0_None,DB_31,DB_32,DB_33,DB_34,DB_35,DB_36,DB_37,
  IN0_A,OUT0_A,DB_3A,DB_3B,DB_3C,DB_3D,DB_3E,DB_3F,
  IN_B_xC,OUT_xC_B,SBC_HL_BC,LD_xWORDe_BC,NEG,RETN,IM_0,LD_I_A,
  IN_C_xC,OUT_xC_C,ADC_HL_BC,LD_BC_xWORDe,MLT_BC,RETI,DB_,LD_R_A,
  IN_D_xC,OUT_xC_D,SBC_HL_DE,LD_xWORDe_DE,DB_54,DB_55,IM_1,LD_A_I,
  IN_E_xC,OUT_xC_E,ADC_HL_DE,LD_DE_xWORDe,MLT_DE,DB_5D,IM_2,LD_A_R,
  IN_H_xC,OUT_xC_H,SBC_HL_HL,LD_xWORDe_HL,DB_64,DB_65,DB_66,RRD,
  IN_L_xC,OUT_xC_L,ADC_HL_HL,LD_HL_xWORDe,MLT_HL,DB_6D,DB_6E,RLD,
  IN_F_xC,DB_71,SBC_HL_SP,LD_xWORDe_SP,DB_74,DB_75,DB_76,DB_77,
  IN_A_xC,OUT_xC_A,ADC_HL_SP,LD_SP_xWORDe,MLT_SP,DB_7D,DB_7E,DB_7F,
